...
This script implements the steps outlined in the README for fine-tuning a small language model
on the Open-R1-Math-220k dataset for mathematical reasoning.
"""
...
def create_train_val_split(dataset):
    ...
    if 'validation' in dataset:
        ...
        train_problems, val_problems, train_solutions, val_solutions, train_answers, val_answers = train_test_split(
            train_problems, train_answers, train_solutions, test_size=0.1, random_state=42
        )
...
# Step 3: Answer Extraction and Reward Functions
...
def test_extraction_function():
    ...
    test_outputs = [
        ...
        "<reasoning>Some steps</reasoning><answer>15</answer>",
        "The speed of the river is v_{R}=4 km/h, and the speed of the boat is v_{B}=10 km/h."
    ]
    test_answers = ["4", "10.5", "42", "15", "v_{R}=4 km/h, and the speed of the boat is v_{B}=10 km/h"]
    ...
    for output, answer in zip(test_outputs, test_answers):
        ...
        print(f"Match: {compare_answers(extracted, answer)}\n")

# Step 4: Model Loading and Training Setup
...
# Add a custom callback for wandb logging
